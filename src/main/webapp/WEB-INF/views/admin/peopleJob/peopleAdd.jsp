...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="peopleJobAddForm" method="post" enctype=”multipart/form-data”>
            <table class="grid" border=1>
                <tr>
                    ...
                    <td>职级</td>
                    <td>
                        <input type="text" name="jobLevel" id="jobLevel" data-options="required:true">
                    </td>
                    <td>岗位薪资</td>
                    <td>
                        <input type="text" name="salary" id="salary" class="easyui-numberbox" precision="2" style="text-align:right;"/>
                    </td>
                </tr>
