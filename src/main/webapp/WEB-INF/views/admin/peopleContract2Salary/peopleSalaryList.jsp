...
<script type="text/javascript">
    ...
    $(function () {
        salaryGrid = $('#salaryGrid').datagrid({
            url: '${path}/peopleContract2Salary/salaryGrid',
            fit: true,
            striped: true,
    ...
    function addSalaryBaseFun() {
        parent.$.modalDialog({
            ...
            height: 600,
            maximizable:true,
            href: '${path}/peopleContract2Salary/salaryBasePage?peopleCode=${code}',
            buttons:[{
                text: '修改',
                handler: function(){
                    ...
                    if(parent.checkForm()) {
                        parent.SYS_SUBMIT_FORM(f, "/peopleContract2Salary/salaryBaseEdit", function (data) {
                            if (!data["success"]) {
                                parent.progressClose();
                                parent.$.messager.alert("提示", data["msg"], "warning");
                            } else {
