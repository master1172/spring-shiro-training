        ...
        <form id="peopleEditForm" method="post" enctype=”multipart/form-data”>
            ...
            <table class="grid" border=1>
                ...
                <tr>
                    <td>联系电话</td>
                    <td>
                        <input type="text" name="mobile" value="${peopleTemp.mobile}" class="easyui-validatebox" data-options="validType:'length[1,11]'">
                    </td>
                    <td>现住址</td>
                    <td>
                ...
                <tr>
                    <td>部门</td>
                    <td>
                        <input type="text" name="extraDepartmentName" value="${peopleTemp.extraDepartmentName}">
                    </td>
                    <td>工种</td>
                    <td>
