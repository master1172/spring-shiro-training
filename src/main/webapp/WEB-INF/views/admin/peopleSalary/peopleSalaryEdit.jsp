        ...
        <form id="salaryEditForm" method="post">
            <table class="grid" border=1>
                ...
                <tr>
                    <td>提租补贴</td>
                    <td>
                        <input name="rentAllowance" id="rentAllowance" type="text" value="${peopleSalary.rentAllowance}" class="easyui-numberbox" precision="2" style="text-align:right;"/>
                    </td>
                    <td>购房补贴</td>
                    <td>
                        <input name="houseAllowance" id="houseAllowance" type="text" value="${peopleSalary.houseAllowance}" class="easyui-numberbox" precision="2" style="text-align:right;"/>
                    </td>
                    <td>参加工作日期</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>值班天数</td>
                    <td>
                        <input name="onDutyDate" id="onDutyDate" type="text" value="${peopleSalary.onDutyDate}" class="easyui-numberbox" precision="2" style="text-align:right;"/>
                    </td>
                    <td>值班费合计</td>
                    <td>
                        <input name="onDutyFeeTotal" id="onDutyFeeTotal" type="text" value="${peopleSalary.onDutyFeeTotal}" class="easyui-numberbox" precision="2" style="text-align:right;"/>
                    </td>
                    <td>物业补贴</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>应发合计</td>
                    <td>
                        <input name="grossSalary" id="grossSalary" type="text" value="${peopleSalary.grossSalary}" class="easyui-numberbox" precision="2" style="text-align:right;"/>
                    </td>
                </tr>
                <tr>
                    <td>养老保险</td>
                ...
                <tr>
                    ...
                    <td>扣款</td>
                    <td>
                        <input name="expense" id="expense" type="text" value="${peopleSalary.expense}" class="easyui-numberbox" precision="2" style="text-align:right;"/>
                    </td>
                    <td>代扣税</td>
                    <td>
                        <input name="tax" id="tax" type="text" value="${peopleSalary.tax}" class="easyui-numberbox" precision="2" style="text-align:right;"/>
                    </td>
                    <td>实发合计</td>
                    <td>
                        <input name="netIncome" id="netIncome" value="${peopleSalary.netIncome}" type="text" class="easyui-numberbox" precision="2" style="text-align:right;"/>
                    </td>
                </tr>
                <tr>
                    <td>发薪日</td>
