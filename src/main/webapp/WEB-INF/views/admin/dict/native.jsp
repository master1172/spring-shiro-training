    ...
    <script type="text/javascript">
            ...
            parent.$.modalDialog({
                ...
                buttons: [{
                    ...
                    handler: function () {
                        ...
                        parent.SYS_SUBMIT_FORM(f, "/dict/native/add", function (data) {
                            if (!data["success"]) {
        ...
        function editFun(id) {
            ...
            parent.$.modalDialog({
                ...
                width: 500,
                height: 300,
                href: '${path}/dict/native/editPage?id=' + id,
                buttons: [{
                    text: '修改',
                    handler: function () {
                        ...
                        parent.SYS_SUBMIT_FORM(f, "/dict/native/edit", function (data) {
                            if (!data["success"]) {
                                parent.progressClose();
                                parent.$.messager.alert("提示", data["msg"], "warning");
                            } else {
