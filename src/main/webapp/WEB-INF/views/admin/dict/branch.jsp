    ...
    <script type="text/javascript">
            ...
            parent.$.modalDialog({
                ...
                buttons: [{
                    ...
                    handler: function () {
                        ...
                        parent.SYS_SUBMIT_FORM(f, "/dict/branch/add", function (data) {
                            if (!data["success"]) {
        ...
        function editFun(id) {
            ...
            parent.$.modalDialog({
                ...
                width: 500,
                height: 300,
                href: '${path}/dict/branch/editPage?id=' + id,
                buttons: [{
                    text: '修改',
                    handler: function () {
                        ...
                        parent.SYS_SUBMIT_FORM(f, "/dict/branch/edit", function (data) {
                            if (!data["success"]) {
                                parent.progressClose();
                                parent.$.messager.alert("提示", data["msg"], "warning");
                            } else {
