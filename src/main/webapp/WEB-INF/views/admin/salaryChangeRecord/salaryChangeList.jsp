    ...
    <div data-options="region:'center',border:true,title:'工资发放列表'">
        <table id="salaryGrid" data-options="fit:true,border:false">
            ...
            <tr>
                ...
                <th field="changeDate"      data-options="sortable:false" width="80">变化日期</th>
                <th field="prevJobLevel"    data-options="sortable:false" width="80">前职级</th>
                <th field="prevJobSalary"   data-options="sortable:false" width="80">前职级工资</th>
                <th field="newJobLevel"     data-options="sortable:false" width="80">新职级</th>
                <th field="newJobSalary"    data-options="sortable:false" width="80">新职级工资</th>
                <th field="prevRankLevel"   data-options="sortable:false" width="80">前薪级</th>
                <th field="prevRankSalary"  data-options="sortable:false" width="80">前薪级工资</th>
                <th field="newRankLevel"    data-options="sortable:false" width="80">新职级</th>
                <th field="newRankSalary"   data-options="sortable:false" width="80">新职级工资</th>
