    ...
    <script type="text/javascript">
            ...
            parent.$.modalDialog({
                ...
                buttons:[{
                    ...
                    handler: function(){
                        ...
                        var f = parent.$.modalDialog.handler.find("#peopleSearchForm");
                        if(parent.checkForm()){
                            parent.SYS_SUBMIT_FORM(f, "/peopleContract2/exportSearch",function(data){
                                if(!data["success"]){
                                    parent.progressClose();
                                    parent.$.modalDialog.handler.dialog("close");
                                    ...
                                    form.attr("action",'${path}'+"/peopleContract2/exportExcel");
                                    $("#downLoadForm").submit();
                                }
                            });
                        }
            ...
            parent.$.modalDialog({
                ...
                buttons: [{
                    ...
                    handler: function () {
                        ...
                        //f.submit();
                        if(parent.checkForm()){
                            parent.SYS_SUBMIT_FORM(f,"/peopleContract2/edit",function(data){
                                if(!data["success"]){
                                    parent.progressClose();
                                    parent.$.messager.alert("提示", data["msg"], "warning");
                                }else{
        ...
        function deleteFun(id) {
            ...
            parent.$.messager.confirm('询问', '您是否要删除当前人员？', function (b) {
                if (b) {
                    progressLoad();
                    $.post('${path}/peopleContract2/delete',{
                        id: id
                    }, function (result) {
                        if (result.success) {
        ...
        function batchDel(){
            ...
            parent.$.messager.confirm('询问', '您是否要删除所选人员？', function (b) {
                if (b) {
                    progressLoad();
                    $.post('${path}/peopleContract2/batchDel', {
                        ids: ids.join(",")
                    }, function (result) {
                        if (result.success) {
                            parent.$.messager.alert('提示', result.msg, 'info');
        ...
        function importExcel(){
            parent.$.modalDialog({
                ...
                width: 500,
                height: 300,
                href: '${path}/peopleContract2/importExcelPage',
                buttons: [{
                    text: '导入',
                    handler: function () {
                        parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
                        ...
                        //f.submit();
                        if(parent.checkForm()){
                            parent.SYS_SUBMIT_FORM(f,"/peopleContract2/importExcel",function(data){
                                if(!data["success"]){
                                    parent.progressClose();
                                    parent.$.messager.alert("提示", data["msg"], "warning");
                                }else{
        ...
        function exportWord(){
            ...
            if(checkedItems.length==1){
                ...
                form.attr("action",'${path}'+"/peopleContract2/exportWord");
                $("#downLoadForm").submit();
            }else{
