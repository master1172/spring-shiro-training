    ...
    <script type="text/javascript">
        ...
        function advSearch() {
            parent.$.modalDialog({
                ...
                width: 1000,
                height: 600,
                href: '${path}/recruit/advSearchPage',
                buttons: [{
                    text: '提交',
                    handler: function () {
        ...
        function exportSearch() {
            parent.$.modalDialog({
                ...
                width: 1000,
                height: 600,
                href: '${path}/recruit/exportSearchPage',
                buttons: [{
                    text: '导出',
                    handler: function () {
                        parent.$.modalDialog.openner_dataGrid = dataGrid;
                        var f = parent.$.modalDialog.handler.find("#peopleSearchForm");
                        if (parent.checkForm()) {
                            parent.SYS_SUBMIT_FORM(f, "/recruit/exportSearch", function (data) {
                                if (!data["success"]) {
                                    parent.progressClose();
                                    parent.$.modalDialog.handler.dialog("close");
                                    ...
                                    form.attr("action", '${path}' + "/recruit/exportExcel");
                                    $("#downLoadForm").submit();
                                }
                            });
                        }
            ...
            parent.$.modalDialog({
                ...
                buttons: [{
                    ...
                    handler: function () {
                        ...
                        if (parent.checkForm()) {
                            parent.SYS_SUBMIT_FORM(f, "/recruit/add", function (data) {
                                if (!data["success"]) {
                                    parent.progressClose();
                                    parent.$.messager.alert("提示", data["msg"], "warning");
                                } else {
        ...
        function editFun(id) {
            ...
            parent.$.modalDialog({
                ...
                width: 1500,
                height: 600,
                href: '${path}/recruit/editPage?id=' + id,
                buttons: [{
                    text: '修改',
                    handler: function () {
                        ...
                        //f.submit();
                        if (parent.checkForm()) {
                            parent.SYS_SUBMIT_FORM(f, "/recruit/edit", function (data) {
                                if (!data["success"]) {
                                    parent.progressClose();
                                    parent.$.messager.alert("提示", data["msg"], "warning");
                                } else {
        ...
        function importExcel() {
            parent.$.modalDialog({
                ...
                width: 500,
                height: 300,
                href: '${path}/recruit/importExcelPage',
                buttons: [{
                    text: '导入',
                    handler: function () {
                        parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
                        ...
                        //f.submit();
                        if (parent.checkForm()) {
                            parent.SYS_SUBMIT_FORM(f, "/recruit/importExcel", function (data) {
                                if (!data["success"]) {
                                    parent.progressClose();
                                    parent.$.messager.alert("提示", data["msg"], "warning");
                                } else {
...
<div data-options="region:'center',border:true,title:'应聘人员列表'">
