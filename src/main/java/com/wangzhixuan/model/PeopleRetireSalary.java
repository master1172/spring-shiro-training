...
public class PeopleRetireSalary implements Serializable {
    ...
    private BigDecimal retireFeeAllowance;
    ...
    public BigDecimal getRetireFeeAllowance() {
        return retireFeeAllowance;
    }

    public void setRetireFeeAllowance(BigDecimal retireFeeAllowance) {
        this.retireFeeAllowance = retireFeeAllowance;
    }
    ...
    public String toString() {
        ...
        sb.append(", retireFeeAllowance=").append(retireFeeAllowance);
