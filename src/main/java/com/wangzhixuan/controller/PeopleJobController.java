...
public class PeopleJobController extends BaseController{
    ...
    @ResponseBody
    public Result add(PeopleJobVo peopleJobVo, @RequestParam(value="fileName",required=false)CommonsMultipartFile file) {
        Result result = new Result();
        try {

            peopleJobService.addPeopleJob(peopleJobVo,file);
    ...
    @RequestMapping("/edit")
    @ResponseBody
    public Result edit(PeopleJobVo peoplejobvo, @RequestParam(value="fileName",required=false)CommonsMultipartFile file){
        Result result = new Result();
        try{
            peopleJobService.updatePeopleJob(peoplejobvo,file);
            result.setSuccess(true);
            result.setMsg("修改成功!");
            return result;
        }catch(Exception e){
