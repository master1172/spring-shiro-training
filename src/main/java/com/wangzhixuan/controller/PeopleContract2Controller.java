 ...
 */
@Controller
@RequestMapping("/peopleContract2")
public class PeopleContract2Controller extends BaseController{
    private static Logger LOGGER = LoggerFactory.getLogger(PeopleContractController.class);

    @Autowired
    private PeopleContract2Service peopleContractService;
    ...
    public String manager() {
        return "/admin/peopleContract2/people";
    }
    ...
    public String advSearchPage(){
        return "admin/peopleContract2/peopleSearch";
    }

    @RequestMapping(value="/exportSearchPage", method = RequestMethod.GET)
    public String exportSearchPage() { return "admin/peopleContract2/peopleSearch";}
