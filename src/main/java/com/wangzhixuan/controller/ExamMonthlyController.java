...
public class ExamMonthlyController extends BaseController {
  ...
  @ResponseBody
  public PageInfo dataGrid(ExamMonthlyVo examMonthlyVo, Integer page, Integer rows, String sort, String order){
    PageInfo pageInfo = new PageInfo(page, rows);
    Map<String,Object> condition = ExamMonthlyVo.CreateCondition(examMonthlyVo);
  ...
  @ResponseBody
  public Result exportSearch(HttpServletResponse response, ExamMonthlyVo examMonthlyVo) {
  ...
  public Result add(ExamMonthlyVo examMonthlyVo) {
    Result result = new Result();
    try {
      People people = peopleService.findPeopleByName(examMonthlyVo.getName());
